...
const StaffManagerSidebar = ({ onToggle, isMobileOpen, setIsMobileOpen }) => {
  ...
  const SidebarSectionComponent = ({ title, children }) => (
    <div className="mb-4">
      <AnimatePresence>
        {isExpanded && (
          <motion.h3
  ...
  // Create the memoized SidebarSection with proper displayName assignment
  const SidebarSection = React.memo(SidebarSectionComponent);
        ...
        >
          ...
          {/* <SidebarSection title="Staff Management">
            ...
            <SidebarItem
              icon={UserPlus}
              label="Assign Staff"
              href="/staff-manager/assignments"
            />
          </SidebarSection> */}
          ...
          {/* <SidebarSection title="Applications">
            <SidebarItem
              ...
              href="/staff-manager/applications"
            />
            <SidebarItem
              icon={BarChart}
              label="Reports"
              href="/staff-manager/reports"
            />
          </SidebarSection> */}
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                <div className="flex items-center">
                  ...
                  />
                  <span className="text-lg font-bold text-gray-800">Manager Portal</span>
                </div>
                <button
                  onClick={() => setIsMobileOpen(false)}
...
StaffManagerSidebar.displayName = 'StaffManagerSidebar';
