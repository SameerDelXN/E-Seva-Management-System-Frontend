    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="flex items-center mb-8">
          <Link href="/appointment/steps/personal-details" className="text-gray-600 hover:text-gray-800">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <div className="space-y-4">
            <SummaryItem 
              ...
              editable={true}
              editLink="/appointment/steps/personal-details"
            />
            <SummaryItem 
              label="Email Address" 
            ...
            <SummaryItem 
              ...
              editable={true}
              editLink="/appointment/steps/date-time"
            />
            <SummaryItem 
            ...
            <SummaryItem 
              ...
              editable={true}
              editLink="/appointment/steps/select-service"
            />
            <SummaryItem 
